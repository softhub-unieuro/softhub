...
export const PERMISSOES_SISTEMA = [
    {
        ...
        icone: FolderKanban,
        permissoes: [
            { chave: 'tarefas:visualizar_kanban', label: 'Acessar Fluxo Kanban' },
            { chave: 'tarefas:visualizar_backlog', label: 'Acessar Lista de Backlog' },
            { chave: 'tarefas:visualizar_detalhes', label: 'Detalhar Atividades' },
            { chave: 'tarefas:criar', label: 'Registrar Novas Tarefas' },
            { chave: 'tarefas:editar', label: 'Modificar Dados da Tarefa' },
            { chave: 'tarefas:mover', label: 'Avançar Status (Arrastar Cards)' },
            { chave: 'tarefas:arquivar', label: 'Remover/Arquivar Tarefas Finalizadas' },
            { chave: 'tarefas:comentar', label: 'Postar Comentários em Tarefas' },
            { chave: 'tarefas:checklist_marcar', label: 'Interagir com Checklist (Execução)' },
            { chave: 'tarefas:checklist_gerenciar', label: 'Gerenciar Estrutura de Checklist (Planejamento)' },
            { chave: 'tarefas:visualizar_historico', label: 'Auditar Histórico de Alterações' },
        ],
    },
    {
        modulo: 'projetos',
        ...
        icone: Globe,
        permissoes: [
            { chave: 'projetos:visualizar', label: 'Gerir Portfólio de Projetos 🛡️' },
            { chave: 'projetos:criar', label: 'Adicionar Novos Projetos 🛡️' },
            { chave: 'projetos:editar', label: 'Configurar Projetos Existentes 🛡️' },
            { chave: 'projetos:excluir', label: 'Remover Projetos Permanentemente 🛡️' },
            { chave: 'projetos:visualizar_detalhes', label: 'Acessar Painel de Detalhes (Equipe)' },
            { chave: 'projetos:documentos', label: 'Consultar Documentação Técnica' },
        ],
    },
    {
        modulo: 'ponto',
        ...
        icone: Clock,
        permissoes: [
            { chave: 'ponto:registrar', label: 'Realizar Batida de Ponto (Entrada/Saída)' },
            { chave: 'ponto:visualizar', label: 'Consultar Meu Espelho de Ponto' },
            { chave: 'ponto:justificar', label: 'Solicitar Justificativa de Ausência' },
            { chave: 'ponto:aprovar_justificativa', label: 'Auditar e Aprovar Justificativas 🛡️' },
            { chave: 'ponto:gestao_painel', label: 'Centro de Gestão de Presença 🛡️' },
            { chave: 'ponto:exportar', label: 'Exportar Relatórios de Frequência 🛡️' },
        ],
    },
    {
        modulo: 'membros',
        ...
        icone: UserCircle,
        permissoes: [
            { chave: 'membros:gerenciar', label: 'Diretório de Membros & Acessos 🛡️' },
            { chave: 'membros:alterar_role', label: 'Promover/Alterar Cargos 🔒' },
            { chave: 'membros:desativar', label: 'Suspender/Desativar Credenciais 🔒' },
        ],
    },
    {
        modulo: 'avisos',
        ...
        icone: MessageSquare,
        permissoes: [
            { chave: 'avisos:visualizar', label: 'Ler Mural de Avisos' },
            { chave: 'avisos:criar', label: 'Publicar Comunicados Oficiais 🛡️' },
            { chave: 'avisos:remover', label: 'Arquivar Comunicados 🛡️' },
    ...
    },
    {
        ...
        icone: LayoutGrid,
        permissoes: [
            { chave: 'equipes:visualizar', label: 'Explorar Hierarquia e Equipes' },
            { chave: 'equipes:criar_grupo', label: 'Fundar Novos Grupos 🛡️' },
            { chave: 'equipes:editar_grupo', label: 'Modificar Estrutura de Grupos 🛡️' },
            { chave: 'equipes:criar_equipe', label: 'Formar Equipes de Projeto 🛡️' },
            { chave: 'equipes:editar_equipe', label: 'Gerir Composição das Equipes 🛡️' },
            { chave: 'equipes:alocar_membro', label: 'Mover Membros entre Equipes 🛡️' },
        ],
    },
    {
        modulo: 'dashboard',
        ...
        permissoes: [
            { chave: 'dashboard:visualizar', label: 'Acessar Dashboard Executivo' },
        ],
    },
    {
        modulo: 'relatorios',
        ...
        icone: FileText,
        permissoes: [
            { chave: 'relatorios:visualizar', label: 'Gerar Relatórios Gerenciais 🛡️' },
            { chave: 'relatorios:imprimir', label: 'Exportação de Dados p/ Auditoria 🛡️' },
        ],
    },
    {
        modulo: 'logs',
        ...
        icone: Database,
        permissoes: [
            { chave: 'logs:visualizar', label: 'Consultar Trilha de Auditoria 🔒' },
        ],
    },
    {
        ...
        icone: Settings2,
        permissoes: [
            { chave: 'configuracoes:visualizar', label: 'Painel de Governança 🛡️' },
            { chave: 'configuracoes:editar', label: 'Alterar Políticas do Sistema 🔒' },
            { chave: 'configuracoes:matriz_governanca', label: 'Controle Mestre de Acessos 🔒' },
        ],
    },
] as const;
