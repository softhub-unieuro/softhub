...
export const PERMISSOES_SISTEMA = [
    {
        ...
        permissoes: [
            ...
            { chave: 'tarefas:arquivar', label: 'Arquivar / Excluir' },
            { chave: 'tarefas:comentar', label: 'Comentar' },
            { chave: 'tarefas:checklist_marcar', label: 'Marcar Itens do Checklist' },
            { chave: 'tarefas:checklist_gerenciar', label: 'Criar/Excluir Itens do Checklist' },
