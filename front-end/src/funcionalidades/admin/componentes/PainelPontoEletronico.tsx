...
export const PainelPontoEletronico = memo(() => {
    ...
    return (
        <div className="flex flex-col h-full space-y-8 animar-entrada pb-10 max-w-[1600px] mx-auto w-full px-4 sm:px-6">
            ...
            <div className="flex flex-wrap items-center gap-4 bg-slate-50 border border-slate-100 p-4 rounded-[2.5rem]">
                {sections.map((section) => (
                    ...
                    >
                        ...
                        <div className="text-left">
                            ...
                            <p className={`text-[9px] font-medium leading-none ${abaAtiva === section.id ? 'text-indigo-100' : 'text-slate-400'}`}>
                                {section.desc}
                            </p>
                        </div>
                    </button>
